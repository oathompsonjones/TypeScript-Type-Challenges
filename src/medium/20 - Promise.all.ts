/*
    ...
    `Promise<T>` where `T` is the resolved result array.
...
declare function PromiseAll<T extends unknown[]>(values: readonly [...T]): Promise<{
    [K in keyof T]: T[K] extends infer U | Promise<infer U> ? U : never
}>;
...
const promiseAllTest4 = PromiseAll<Array<Promise<number> | number>>([1, 2, 3]);
