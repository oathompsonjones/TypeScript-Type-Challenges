...
type MapTypes<T extends Record<PropertyKey, unknown>, R extends MappingObject> = {
...
export type Cases = [
    ...
    >>,
    Expect<Equal<
    MapTypes<{ name: string; date: Date; }, { mapFrom: Date; mapTo: string; } | { mapFrom: string; mapTo: boolean; }>,
