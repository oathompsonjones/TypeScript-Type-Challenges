/*
    ...
    previously well-defined unique objects (as in the nominal type system), and not any objects that have the required fields.
...
type DeepObjectToUniq<O extends object> = Record<symbol, O> & {
    [K in keyof O]: O[K] extends object
        ? DeepObjectToUniq<O[K]> & Record<symbol, [O, K]>
        : O[K];
};
